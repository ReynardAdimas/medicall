...
//                           GestureDetector(
//                             onTap: () {
//                               _navigateToEditField(
//                                   currentFieldValue: _namaPasien ?? '',
        ...
        child: Column(
          children: [
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    left: 16,
                    right: 16,
                    // Tambahkan properti 'bottom' untuk memberikan batasan tinggi yang jelas
                    // Sesuaikan nilai 20.0 ini agar sesuai dengan tata letak yang Anda inginkan
                    bottom: 20, // Misalnya, 20 pixel dari bawah Stack parent
                    child: Container(
                      width: double.infinity,
                      padding: const EdgeInsets.symmetric(vertical: 20, horizontal: 20),
                      decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: [
                          const SizedBox(height: 50),
                          // Membungkus Text Nama Pasien dengan GestureDetector
                          GestureDetector(
                            onTap: () {
                              _navigateToEditField(
                                currentFieldValue: _namaPasien ?? '',
                            ...
                            child: Text( // Ini adalah Text yang menampilkan nama pasien
                              _namaPasien ?? 'Memuat Nama...',
                              style: const TextStyle(
                                  fontSize: 20, fontWeight: FontWeight.bold),
                            ),
            ...
            _buildProfileDetail(
              label: 'Gender',
              value: _gender ?? 'Memuat...',
              onTap: null, // Asumsi gender tidak bisa diubah di sini
            ),
            _buildProfileDetail(
              label: 'Pekerjaan',
              value: _pekerjaan ?? 'Memuat...',
